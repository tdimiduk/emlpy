...
import numpy as np
from ..scattering.scatterer import Spheres, Sphere, Scatterer
try:
...
def show(o,color=(.5, .5, .5)):
    ...
    if isinstance(o, Sphere):
        if o.r < 1:
            plt.imshow(get_emily_data('puppy1.jpg'))
        else:
            plt.imshow(get_emily_data('puppy2.jpg'))
    elif isinstance(o, Spheres):
        if len(o.scatterers) == 2:
            plt.imshow(get_emily_data('2puppies.jpg'))
        elif len(o.scatterers) == 3:
            plt.imshow(get_emily_data('3puppies.jpg'))
        else:
            plt.imshow(get_emily_data('puppies.jpg'))
