...
from holopy.core.io.io import get_emily_data, get_example_data
...
You can't take the science from me.
...
And you can't take the science from me.
    ...
    """
    return get_example_data('propagated.yaml')
