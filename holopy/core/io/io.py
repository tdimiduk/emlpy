...
def get_emily_data(name, spacing=None, optics=None, metadata=None):
    arr = plt.imread(get_example_data_path(name))
    im = Image(arr, spacing=spacing, optics=optics, metadata=metadata)
    im.color = True
    return im
